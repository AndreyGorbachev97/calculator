...
export default {
  ...
  mounted() {
    ...
    this.GET_ARCHITECTURE_COMPLEXITY_LIST();
    this.GET_INFRASTRUCTURE_COMPLEXITY_LIST();
    this.GET_SOLUTION_INNOVATION_LIST();
    this.GET_STANDARD_MODULES_USING_LIST();
    this.GET_TESTS_DEVELOPMENT_LIST();
  },
  data() {
    return {
  ...
  methods: {
    ...mapActions([
      ...
      'SAVE_NIR_STAGE',
      'DELETE_NIR_STAGE',
      'GET_ARCHITECTURE_COMPLEXITY_LIST',
      'GET_INFRASTRUCTURE_COMPLEXITY_LIST',
      'GET_SOLUTION_INNOVATION_LIST',
      'GET_STANDARD_MODULES_USING_LIST',
      'GET_TESTS_DEVELOPMENT_LIST',
    ]),
  },
};
</script>
